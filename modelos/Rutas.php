...
Class Rutas
{
    ...
    {
        $sql="select * from rutas r inner join institucion e on r.idempresa=e.idinstitucion  
        where 
        e.idinstitucion='$idempresa'";
        return ejecutarConsulta($sql);
    }

    public function listar($idempresa)
    {
        $sql="select * from rutas r inner join institucion e on r.idempresa=e.idinstitucion where e.idinstitucion='$idempresa'";
        return ejecutarConsulta($sql);      
    }
