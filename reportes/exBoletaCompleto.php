...
//$pdf->SetFont('Arial', '', 16);
        ...
        $pdf->addClientAdresse($regv->fecha . "   /  Hora: " . $regv->hora, utf8_decode($regv->cliente), utf8_decode($regv->direccion), $regv->numero_documento, $regv->estado, utf8_decode($regv->vendedorsitio), utf8_decode($regv->descripcion_leyenda_26_2), utf8_decode($regv->tipopago), $regv->nroreferencia, $regv->moneda);
        ...
        while ($regd = $rsptad->fetch_object()) {
            ...
            $line = array(
                ...
                "CANTIDAD" => "$regd->cantidad_item_12" . " " . "$regd->umedidacompra",
                $nombret => $pv,
