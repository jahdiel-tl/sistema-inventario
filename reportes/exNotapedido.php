...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['Ventas'] == 1) {
    ...
    $pdf->addSocietedireccion(htmlspecialchars_decode(utf8_decode("Direción: ") . $datose->almaDireccion));
    //$pdf->addSocietedireccion(htmlspecialchars_decode(utf8_decode("Direción: ") . $datose->domicilio_fiscal)); 
