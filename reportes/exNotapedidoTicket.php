...
if (!isset($_SESSION["nombre"])) {
    ...
    if ($_SESSION['Ventas'] == 1) {
        ...
        <body onload="window.print();">
            ...
            $logo = "../files\usuarios\\" . $reg->imagen; //carmbiar a ruta logo empresa
            ...
            <table align="center">
                <tbody>
                    ...
                    <tr align="center">
                        <td>
                            <?php echo utf8_decode($datose->domicilio_fiscal) . ' - ' . 
                                $datose->telefono1 . 
                                "-" . 
                                $datose->telefono2; 
                            ?>
                    ...
                    <tr align="center">
                        <td>
                            <?php echo utf8_decode(strtolower($reg->almaDireccion)); ?>
                        </td>
                    </tr>
        ...
        <td ><strong>Fecha de Vcto:</strong>
         <?php echo "."; ?></td>
            ...
            <table border="0" align="center" width="220px" style="font-size: 16px">
                <tr>
                    <td>Cant.</td>
                    <td>Producto</td>
                    <td>P.u.</td>
            ...
            <td>" . $reg->faltante . "</td>
                ...
                <tr>
                    <td colspan="5" align="center">
                        <strong>Observacion: </strong><?php echo utf8_decode($reg->descripcion_leyenda_26_2) ?>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" align="center">
