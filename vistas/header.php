...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" href="https://serviceappweb.com/assets/images/brand-logos/fondo.jpg">
        <meta name="apple-mobile-web-app-capable" content="yes">
        <meta name="apple-mobile-web-app-status-bar-style" content="black">
        <meta name="apple-mobile-web-app-title" content="SAW - Home">
        <!-- Choices JS -->
        ...
        <link rel=icon href="assets/images/brand-logos/logo-icon2.png" sizes="32x32" type="image/png">
