...
<head>
	...
	<meta name="author" content="SAW">

	<!-- Open Graph (para redes sociales como Facebook) -->
	<meta property="og:title" content=" Sistema de Facturación Electrónica y Gestión de Inventario" />
	<meta property="og:description"
		content="Sistema robusto de facturación electrónica y gestión de inventario. Mejora la eficiencia de tu negocio con nuestra solución." />
	<meta property="og:image" content="https://serviceappweb.com/assets/images/brand-logos/fondo.jpg" />
	<meta property="og:url" content="https://serviceappweb.com/vistas/login" />
	...
	<meta name="twitter:description"
		content="Demo de un sistema robusto de facturación electrónica y gestión de inventario. Mejora la eficiencia de tu negocio con nuestra solución.">
	<meta name="twitter:image" content="https://serviceappweb.com/assets/images/brand-logos/fondo.jpg">
	...
	<script type="application/ld+json">
	{
	  ...
	  "description": "Sistema robusto de facturación electrónica y gestión de inventario.",
	  "applicationCategory": "BusinessApplication",
	  "operatingSystem": "Web",
	  "screenshot": "https://serviceappweb.com/assets/images/brand-logos/fondo.jpg",
	  "offers": {
		"@type": "Offer",
		"price": "1,100.00",
		"priceCurrency": "PEN",
		"availability": "http://schema.org/InStock",
		"url": "https://serviceappweb.com/vistas/login"
	  }
	}
	</script>
...
<body>
		<div class="wrapper">
			...
			<div class="info-text login">
				<img class="animation" src="../custom/images/logo.png">
				<h4 class="animation">Instituto de Educación Superior Tecnológico Público</h4>
			</div>
			...
			<div class="info-text register">
				<h2 class="animation" style="--i:17; --j:0;">SAW</h2>
