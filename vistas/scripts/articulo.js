...
function init() {
  ...
  //Cargamos los items al select selectPortador


  $.post("../ajax/articulo.php?op=selectPortador", function (r) {
    $("#portador").html(r);
    //$('#unidad_medida').selectpicker('refresh');
...
function actportador() {

  //Cargamos los items al select portador

  $.post("../ajax/articulo.php?op=selectPortador", function (r) {

    $("#portador").html(r);

    //$('#portador').selectpicker('refresh');
