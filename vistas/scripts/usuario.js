...
function limpiar() {
	...
	$("#login").val("");
	$("#clave").val("");
	$("#imagenmuestra").attr("src", "../assets/images/faces/21.jpg");
	$("#imagenactual").val("");
	$("#idusuario").val("");
	$("#almacen").val("");
}
...
function validatepassword(){
	document.getElementById("clave").addEventListener("input", function(event) {
            const password = this.value;
            const minLengthRequirement = document.getElementById("minLengthRequirement");
            ...
            if (password.length >= 8) {
                ...
                minLengthRequirement.style.color = "black";
            }
            ...
            if (/\d/.test(password)) {
                ...
                numberRequirement.style.color = "black";
            }
            ...
            if (/[!@#$%^&*(),.?":{}|<>]/.test(password)) {
                ...
                symbolRequirement.style.color = "black";
            }
        });

        // Validar que las contraseñas coincidan en tiempo real
        document.getElementById("confirmar-contraseña").addEventListener("input", function(event) {
            ...
            if (password === confirmPassword) {
                ...
                alertPassword.innerHTML = '<i class="bi bi-exclamation-triangle-fill"></i> Las contraseñas no coinciden.';
