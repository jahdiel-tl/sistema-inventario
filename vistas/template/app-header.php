            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="#" class="header-logo">
                        <img src="../assets/images/brand-logos/logo-user.png" alt="logo" class="desktop-logo">
                        <img src="../assets/images/brand-logos/logo-user.png" alt="logo" class="toggle-logo">
                        <img src="../assets/images/brand-logos/logo-user.png" alt="logo" class="desktop-dark">
                        <img src="../assets/images/brand-logos/logo-user.png" alt="logo" class="toggle-dark">
                        <img src="../assets/images/brand-logos/logo-user.png" alt="logo" class="desktop-white">
                        <img src="../assets/images/brand-logos/logo-user.png" alt="logo" class="toggle-white">
                    </a>
                </div>
            </div>
            <!-- End::header-element -->
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <!--img src="../assets/images/brand-logos/logo.png" alt="img" width="32"
                                height="32" class="rounded-circle"-->
                            <img src="<?php echo $_SESSION['imagen']; ?>" alt="img" width="32"
                                height="32" class="rounded-circle">
                        </div>
